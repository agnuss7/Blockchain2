...
std::string Names[]={"James ","John ","Bella ","Lisa ","Saul ","Alita ","Levi ","Emeth ","Nicole ","Larry ","Rem ","Alex ","Scarlet ","Mitchell ", "Phoenix ","River ","Jojo ", "Joseph ", "Jonathan ","Ceasar ","Iggy ","Jean ", "Pierre ","Igor ", "Al ","Edd ","Jeff ","Blair ","Suzie ","Sora ","Elijah ","Adrian ","Erina ","Gordon "};
std::string LNames[]={"Kazan","Tresher","von Stroheim","Jenkins","Garland","Thor","Lugosi","Waters","Styx","Woo","Leaven","Argentum","Ramone","Black","Reilly","Sheppard","Worth","Sunderland","Pendleton","Joestar","Quentin","Wright","Alsup","Halloway","Eggstein","Avdol","Araki","Bates","Ora","Quatro","Speedwagon","Fuentes","Newman","Ramsey","Freeman"};
...
int main() {
    ...
    for(int i=0;i<1000;i++){
        User u;
        u.Name=Names[rand()%34]+LNames[rand()%34];
